(function() {
    ...
    function setupGui() {
        ...
        var cameraXPos = gui.add(itemsToControl, 'cameraXPos', -200, 1200);
        var cameraYPos = gui.add(itemsToControl, 'cameraYPos', -200, 1200);
        var cameraZPos = gui.add(itemsToControl, 'cameraZPos', -100, 2400);
        var cameraXRot = gui.add(itemsToControl, 'cameraXRot', -1, 1);
        var cameraYRot = gui.add(itemsToControl, 'cameraYRot', -3.5, 3.5);
        ...
        cameraXRot.onChange(function (value) {
            rotate(camera, 'x', value)
        });
        cameraYRot.onChange(function (value) {
            rotate(cameraPivot, 'y', value)
        });
